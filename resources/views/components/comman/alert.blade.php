@session('success')
    <div id="alert-border-3 success" x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
...
@endsession
@session('warning')
    <div id="alert-border-4 warning" x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
...
@endsession
@session('info')
    <div id="alert-border-1 info" x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
...
@endsession
@session('error')
    <div id="alert-border-2 error" x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
...
@session('note')
    <div id="alert-border-5 note"x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
        ...
        <div class="text-sm font-medium text-gray-800 ms-3 dark:text-gray-300">
            A simple dark alert with an <a href="#"
                class="font-semibold underline hover:text-gray-800 hover:no-underline dark:text-gray-300">example link</a>.
