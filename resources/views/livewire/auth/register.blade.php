        ...
        <form action="" wire:submit='register'>
            ...
            <div class="max-w-xs mx-auto">
                <input
                    ...
                    type="text" placeholder="Name" id="name" wire:model='name' />
                @error('name')
                ...
                <input
                    ...
                    type="email" placeholder="Email" id="email" wire:model='email' />
                @error('email')
                    <spam class="text-red-500 -semi">{{ $message }}</spam>
                @enderror
                <input
                    class="w-full px-8 py-4 mt-5 text-sm font-medium placeholder-gray-500 bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-gray-400 focus:bg-white"
                    type="password" placeholder="Password" id="password" wire:model='password' />
                @error('password')
                    <spam class="text-red-500">{{ $message }}</spam>
                @enderror
                <input
                ...
                <h2 class="mt-5 text-center">
                    <a href="{{ route('login') }}" wire:navigate
                        class="font-bold text-center text-blue-600 underline-offset-1">
